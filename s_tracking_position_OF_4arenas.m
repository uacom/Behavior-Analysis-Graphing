function [] = s_tracking_position_OF_4arenas(filename,interval_num,maxi,varargin) 
...
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%% THESE BOTH WORKS:
% s_tracking_position_OF_4arenas('F:\dDrive_HP_Feb 2017on\DATA\By Person\S Qiu\Ethiovision\SQ behav trials\open field 4 arena 01242019\Export Files\Raw data-open field 4 arena 01242019-Trial    10.xlsx', 15, 0.15,4);
% s_tracking_position_OF_4arenas('F:\dDrive_HP_Feb 2017on\DATA\By Person\S Qiu\Ethiovision\SQ behav trials\cSDS SI 4 arean dev holder - 02042019\Export Files\Raw data-cSDS SI 4 arean dev holder - 02042019-Trial     1.xlsx', 15, 0.15,4);
% s_tracking_position_OF_4arenas('open field one arena 12 min.xlsx', 15, 0.15,4);

%%
% GH data
% s_tracking_position_OF_4arenas('G:\Qiu lab\data\behaviour\02062019 open field -GH\Export Files\Raw data-02062019 open field -GH-Trial     1.xlsx', 15, 0.15,4);
